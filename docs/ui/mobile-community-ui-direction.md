...
- `gamer-mobile-community-ui`: project-local skill for this Android pet-community app. Source copy: `D:\workspace4Cursor\pet\gamer\docs\skills\gamer-mobile-community-ui\SKILL.md`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-generation-compact-console-ui.png`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-generation-empty-brief-first.png`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-generation-compact-required-label.png`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-generation-compact-hero-prompt-filled.png`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-community-quick-icons.png`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-profile-compact-hero.png`.
...
- Screenshot artifacts: `D:\workspace4Cursor\pet\gamer\tmp-gamer-community-feed-card-top.png`, `D:\workspace4Cursor\pet\gamer\tmp-gamer-community-feed-card-controls.png`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-community-showcase-empty-cta.png`.
...
- Screenshot artifacts: `D:\workspace4Cursor\pet\gamer\tmp-gamer-header-generate.png`, `D:\workspace4Cursor\pet\gamer\tmp-gamer-header-profile.png`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-generation-hero-copy.png`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-header-utility-dock.png`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-readable-system-bars.png`.
...
- Screenshot artifact: `D:\workspace4Cursor\pet\gamer\tmp-gamer-community-market-ui-final.png`.
...
- When the selected approved pet changes while the floating pet is already running, refresh the existing overlay preview from the stored public preview URL without implicitly creating a new overlay if the service state is stale.
- The foreground notification may show the active approved pet display name, but it must normalize whitespace and reject URLs, public artifact routes, artifact IDs, or internal paths before displaying it.
